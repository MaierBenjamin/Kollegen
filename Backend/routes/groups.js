...
groupRouter.get("/single", checkAuth, routeWrapper(groupHandler.getGroup))
...
groupRouter.get("/channel/messages", checkAuth, routeWrapper(groupHandler.getChannelMessages))
